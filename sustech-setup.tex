...
\thusetup{
  ...
  %
  title  = {面向大模型推理任务的批式调度 \\ 和KV缓存优化方法研究},
  title* = {Batch Scheduling and KV Cache Optimization for Large Language Model Inference},
  ...
  % 学位
  %
  degree-domain = {电子信息}, % 【中文】学科门类：可选理学、工学、医学
  degree-domain* = {Electronic and Information Engineering}, % 【英文】学位等级：可选Science, Engineering, Medicine
  degree-type = {professional},  % 学位类型：可选学术型（academic）【默认值】、专业型（professional）。
  %
  % 培养单位
  %   填写所属院系的全名
  %   超长英文系名可以手动换行
  department = {深圳理工大学},
  department* = {Shenzhen University of Advanced Technology},
  %
  % 学科
  %   1. 学术型学位
  ...
  %
  supervisor  = {徐敏贤 副研究员},
  supervisor* = {Associate Prof. Xu Minxian},
  % 副指导教师
  %   一般无需启用该项，留空或者注释掉即可。
  ...
  %
  natclassifiedindex={TP311.5},
  intclassifiedindex={004.41},
}
